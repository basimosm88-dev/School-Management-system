...
const StudentProfile = ({ student, onClose, classes, schoolName }) => {
 ...
 <thead className="bg-slate-50 dark:bg-slate-800/50 text-label text-slate-400/80">
 <tr>
 ...
 <p className="text-label text-slate-600 dark:text-slate-400/80 leading-relaxed italic bg-slate-50 dark:bg-slate-800/50 p-4 rounded-xl border border-slate-100 dark:border-slate-800/50">
...
const PrintableStudentProfile = ({ student, classes, schoolName }) => {
 ...
 <p className="text-slate-900">{schoolName} Administration</p>
