...
const AdminDashboard = () => {
 ...
 <h2 className="text-2xl font-semibold text-slate-900 dark:text-white tracking-tight">{t('dashboard')}</h2>
 <p className="text-sm font-medium text-slate-500 mt-1">{t('dashboardSubtitle')}</p>
 </div>

 {/* Welcome Section */}
 <div className="mb-8 p-6 bg-gradient-to-r from-primary to-indigo-600 rounded-2xl text-white shadow-lg shadow-primary/20">
 <h1 className="text-2xl font-semibold mb-1">{t(greetingKey)}, {currentUser?.name || 'Admin'}!</h1>
 <p className="text-white/80 text-sm">Here is what is happening in your school today.</p>
 </div>
 ...
 <div>
 <h2 className="text-lg font-semibold text-slate-900 dark:text-slate-100 tracking-tight">Attendance Report</h2>
 <p className="text-sm font-medium text-slate-500 dark:text-slate-400 mt-1">Daily presence vs absence tracking</p>
 </div>
 ...
 className="appearance-none bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl px-4 py-2 pr-10 text-xs font-semibold text-slate-600 dark:text-slate-300 outline-none focus:ring-2 focus:ring-primary/20 transition-all cursor-pointer"
 >
 ...
 <span className="text-xs text-slate-400 font-bold ">{day.date?.split('-').slice(1).join('/')}</span>
 )}
 </div>
 ))}
 </div>
 ...
 <h2 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-6">{t('topPerformers')}</h2>
 ...
 {/* RECENT ACTIVITY */}
 <section className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200/80 dark:border-slate-700/50 p-6 shadow-sm transition-colors">
 <h2 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-6">{t('recentActivity')}</h2>
 ...
 {/* GENDER DISTRIBUTION */}
 <section className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200/80 dark:border-slate-700/50 p-6 shadow-sm transition-colors">
 <h2 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-6">{t('studentGenders')}</h2>
 ...
 {/* UPCOMING EVENTS */}
 <section className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200/80 dark:border-slate-700/50 p-6 shadow-sm transition-colors">
 <h2 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-6">{t('upcomingEvents')}</h2>
 <div className="space-y-4">
 ...
 <p className="text-primary text-xs font-bold mt-1">{event.date}</p>
 </div>
 ))
 )}
 </div>
 ...
 {/* ANNOUNCEMENTS */}
 <section className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200/80 dark:border-slate-700/50 p-6 shadow-sm transition-colors">
 <h2 className="text-lg font-bold text-slate-900 dark:text-slate-100 mb-6">{t('announcements')}</h2>
 <div className="space-y-4">
 ...
 <p className="text-xs text-slate-500 dark:text-slate-400 mt-1 line-clamp-2">{ann.content || ann.message || ''}</p>
 </div>
 ))
 )}
 </div>
