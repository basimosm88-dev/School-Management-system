...
const SettingsPage = () => {
 ...
 <h2 className="text-headline-sm text-slate-900 dark:text-white">{t('settings')}</h2>
 <p className="text-body-sm text-slate-500 mt-1">{t('settingsSubtitle')}</p>
 </div>
 ...
 >
 <span className="material-symbols-outlined text-headline-sm">{section.icon}</span>
 {section.label}
 </button>
 ))}
 <button 
 ...
 >
 <span className="material-symbols-outlined text-headline-sm">factory</span>
 Factory Reset
 </button>
 </div>
 ...
 <h2 className="text-headline-sm text-slate-900 dark:text-white flex items-center gap-3">
 ...
 <span className="material-symbols-outlined text-display-bold text-slate-300">add_a_photo</span>
 )}
 </div>
 ...
 <p className="text-body-sm text-slate-500 dark:text-slate-400">Upload your official school logo. This will appear on all dashboards and PDF reports.</p>
 </div>
 </div>

 <div className="grid grid-cols-2 gap-6">
 <div className="space-y-1.5">
 <label className="text-body-sm text-slate-500">{t('schoolName')}</label>
 <input 
 type="text" 
 ...
 <div className="space-y-1.5">
 <label className="text-body-sm text-slate-500">Official Email</label>
 <input 
 type="email" 
 ...
 <div className="space-y-1.5">
 <label className="text-body-sm text-slate-500">Contact Phone</label>
 <input 
 type="text" 
 ...
 <div className="space-y-1.5">
 <label className="text-body-sm text-slate-500">Website URL</label>
 <input 
 type="text" 
 ...
 <label className="text-body-sm text-slate-500">Physical Address</label>
 <textarea 
 rows="2"
 ...
 <div className="space-y-1.5">
 <label className="text-body-sm text-slate-500">Global Passing Grade (%)</label>
 <input 
 type="number" 
 ...
 <div className="space-y-1.5">
 <label className="text-body-sm text-slate-500">Min. Subjects for Promotion</label>
 <input 
 type="number" 
 ...
 <span className="text-body-sm text-slate-600 dark:text-slate-400 capitalize">{key.replace(/([A-Z])/g, ' $1').trim()}</span>
 ...
 <p className="text-body-sm text-slate-400 italic">Total must equal 100% for correct average calculations.</p>
 </div>
 </div>
 </div>
 )}
 ...
 <div className="space-y-6">
 <div className="space-y-4">
 <h3 className="text-body-sm text-slate-400">Teacher Permissions</h3>
 ...
 <div className="space-y-4">
 <h3 className="text-body-sm text-slate-400">Student Permissions</h3>
 <div className="grid grid-cols-2 gap-4">
 ...
 <div className="space-y-4">
 <div className="space-y-1.5">
 <label className="text-body-sm text-slate-500">Principal Signature Label</label>
 ...
 <div className="space-y-1.5">
 <label className="text-body-sm text-slate-500">{t('managerSignature')}</label>
 ...
 <div className="space-y-1.5">
 <label className="text-body-sm text-slate-500">Academic Manager Label</label>
 ...
 <div className="col-span-2 space-y-1.5">
 <label className="text-body-sm text-slate-500">PDF Footer Text</label>
 ...
 <div className="space-y-1.5">
 <label className="text-body-sm text-slate-500">Minimum Password Length</label>
 ...
 <div className="space-y-1.5">
 <label className="text-body-sm text-slate-500">Session Timeout (Minutes)</label>
 ...
 <div className="grid grid-cols-2 gap-6">
 <div className="space-y-4">
 <h3 className="text-body-sm text-slate-400">System Language</h3>
 <select 
 value={language}
 ...
 <div className="space-y-4">
 <h3 className="text-body-sm text-slate-400">System Theme</h3>
 <div className="flex gap-4">
 <button onClick={() => { if (darkMode) toggleDarkMode(); }} className={`flex-1 py-3 rounded-xl border-2  text-body-sm transition-all ${!darkMode ? 'border-primary bg-primary/5 text-primary' : 'border-slate-100 dark:border-slate-800 text-slate-400'}`}>Light</button>
 <button onClick={() => { if (!darkMode) toggleDarkMode(); }} className={`flex-1 py-3 rounded-xl border-2  text-body-sm transition-all ${darkMode ? 'border-primary bg-primary/5 text-primary' : 'border-slate-100 dark:border-slate-800 text-slate-400'}`}>Dark</button>
 </div>
 </div>
 </div>
 </div>
 ...
 <p className="text-body-sm text-slate-400 flex items-center gap-2">
