...
const AdminExamsPage = () => {
 ...
 {/* TABS */}
  <div className="flex bg-slate-100 dark:bg-slate-800 p-1.5 rounded-xl w-full md:w-auto self-start">
    {[
      ...
      <button
        ...
        className={`flex-1 md:w-48 py-3 rounded-lg text-label transition-all ${
          activeTab === tab.id 
