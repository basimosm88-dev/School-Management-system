...
const TeachersPage = () => {
 ...
 <h2 className="text-headline-sm text-slate-900 dark:text-white">{t('teachers')}</h2>
 <p className="text-body-sm text-slate-500 mt-1">{t('teachersSubtitle')}</p>
 </div>
 ...
 <span className="text-body-sm text-slate-400">{teacher.specialty}</span>
 </div>
 </td>
 <td className="px-6 py-4">
 ...
 <span className="text-slate-400 text-body-sm italic">Unassigned</span>
 )}
 </div>
 </td>
 <td className="px-6 py-4">
 ...
 <span className="material-symbols-outlined text-display-bold mb-2 opacity-30">person_off</span>
...
const TeacherForm = ({ teacher, onClose, onSave, classes, subjects }) => {
 ...
 <div>
 <label className="text-body-sm text-slate-500 dark:text-slate-400 mb-1.5 block">Marital Status</label>
 ...
 <label className="text-body-sm text-slate-500 dark:text-slate-400 mb-1.5 block">Residential Address</label>
 ...
 <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
 <div>
 <label className="text-body-sm text-slate-500 dark:text-slate-400 mb-1.5 block">Email Address (Login Username)</label>
 ...
 <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
 <div>
 <label className="text-body-sm text-slate-500 dark:text-slate-400 mb-1.5 block">Specialty</label>
 ...
 <div>
 <label className="text-body-sm text-slate-500 dark:text-slate-400 mb-1.5 block">Subjects (Multi-select)</label>
 ...
 <div className="col-span-full">
 <label className="text-body-sm text-slate-500 dark:text-slate-400 mb-1.5 block">Assign Classes (Multi-select)</label>
 <div className="flex flex-wrap gap-2 mt-2">
 {classes.map(c => (
 <button
 key={c.id}
 ...
 <div>
 <label className="text-body-sm text-slate-500 dark:text-slate-400 mb-1.5 block">Started Date (In Profession)</label>
 ...
 <div>
 <label className="text-body-sm text-slate-500 dark:text-slate-400 mb-1.5 block">Joined Date (At School)</label>
 ...
 <div>
 <label className="text-body-sm text-slate-500 dark:text-slate-400 mb-1.5 block">Education Level</label>
 ...
 <div>
 <label className="text-body-sm text-slate-500 dark:text-slate-400 mb-1.5 block">Last Certificate</label>
 ...
 <div>
 <label className="text-body-sm text-slate-500 dark:text-slate-400 mb-1.5 block">Extra Certificates</label>
 ...
 <label className="text-body-sm text-slate-500 dark:text-slate-400 mb-1.5 block">Where Trained?</label>
 ...
 <label className="text-body-sm text-slate-500 dark:text-slate-400 mb-1.5 block">Other Languages</label>
 ...
 <div>
 <label className="text-body-sm text-slate-500 dark:text-slate-400 mb-1.5 block">Relation Type</label>
 ...
 <label className="text-body-sm text-slate-500 dark:text-slate-400 mb-1.5 block">Address</label>
 ...
 <div>
 <label className="text-body-sm text-slate-500 dark:text-slate-400 mb-1.5 block">Email (Optional)</label>
...
const TeacherProfile = ({ teacher, onClose, classes, schoolName }) => {
 ...
 <div>
 <h3 className="text-stat-value mb-1">{teacher.name}</h3>
 ...
 <div className="col-span-full">
 <p className="text-body-sm text-slate-400 mb-3">Subjects Taught</p>
 ...
 <span className="material-symbols-outlined text-indigo-600 text-headline-sm">class</span>
 </div>
 <div>
 <p className="text-body-sm text-slate-800 dark:text-slate-100">{cls?.name}</p>
 <p className="text-body-sm text-slate-400">Active Class</p>
 </div>
 </div>
 );
 })}
...
const PrintableTeacherProfile = ({ teacher, classes, schoolName }) => {
 ...
 <span className="material-symbols-outlined text-display-bold">work</span>
 </div>
 <div>
 <h1 className="text-stat-value">{schoolName}</h1>
 <p className="text-body-sm text-slate-500">Official Teacher Record</p>
 </div>
 </div>
 ...
 <p className="mt-1 font-mono text-body-sm text-slate-400">Employee ID: TCH-{teacher.id}</p>
 </div>
 </div>

 <div className="flex justify-between items-center mb-8">
 <h2 className="text-headline-sm border-l-4 border-indigo-600 pl-4">Teacher Performance & Profile Record</h2>
 ...
 <p className="text-body-sm text-slate-500">Manager Signature</p>
 </div>
 <div className="text-center w-48">
 <div className="h-16 border-b border-slate-300 mb-2"></div>
 <p className="text-body-sm text-slate-500">Teacher Signature</p>
 </div>
 </div>
 </div>
 );
...
const FormSectionHeader = ({ icon, title }) => (
 ...
 <span className="material-symbols-outlined text-primary text-stat-value">{icon}</span>
 </div>
...
const ProfileSection = ({ title, icon, children }) => (
 ...
 <span className="material-symbols-outlined text-primary text-headline-sm">{icon}</span>
 <h4 className="text-body-sm text-slate-500 dark:text-slate-400">{title}</h4>
 </div>
 <div className="p-6">
 {children}
 </div>
...
const InfoItem = ({ label, value }) => (
 ...
 <p className="text-body-sm text-slate-400">{label}</p>
