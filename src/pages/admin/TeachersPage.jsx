...
const TeachersPage = () => {
  ...
  const filteredTeachers = useMemo(() => {
    return teachers.filter(teacher => {
      ...
      const matchesClass = !filters.classId || (teacher.assignedClasses || []).some(id => String(id) === String(filters.classId));
...
const ProfileSection = ({ title, icon, children }) => (
  <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-100 dark:border-slate-800 shadow-sm overflow-hidden transition-colors">
    <div className="px-6 py-4 border-b border-slate-50 dark:border-slate-800 flex items-center gap-2 bg-slate-100/50 dark:bg-slate-800/30">
