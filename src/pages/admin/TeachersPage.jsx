...
const TeachersPage = () => {
 ...
 <h2 className="text-xl font-semibold text-slate-900 dark:text-white tracking-tight">{t('teachers')}</h2>
 <p className="text-xs font-bold text-slate-500 mt-1">{t('teachersSubtitle')}</p>
 </div>
 ...
 <span className="text-xs text-slate-400 font-bold tracking-tight">{teacher.specialty}</span>
 </div>
 </td>
 <td className="px-6 py-4">
 ...
 <span key={cid} className="px-1.5 py-0.5 bg-blue-50 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400 rounded text-xs font-bold ">
 ...
 <td className="px-6 py-4">
 <span className={`px-2 py-1 rounded text-xs font-bold ${teacher.status === 'Active'
...
const TeacherForm = ({ teacher, onClose, onSave, classes, subjects }) => {
 ...
 <div>
 <label className="text-xs font-bold text-slate-500 dark:text-slate-400 mb-1.5 block">Marital Status</label>
 ...
 <label className="text-xs font-bold text-slate-500 dark:text-slate-400 mb-1.5 block">Residential Address</label>
 ...
 <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
 <div>
 <label className="text-xs font-bold text-slate-500 dark:text-slate-400 mb-1.5 block">Email Address (Login Username)</label>
 ...
 <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
 <div>
 <label className="text-xs font-bold text-slate-500 dark:text-slate-400 mb-1.5 block">Specialty</label>
 ...
 <div>
 <label className="text-xs font-bold text-slate-500 dark:text-slate-400 mb-1.5 block">Subjects (Multi-select)</label>
 ...
 <div className="col-span-full">
 <label className="text-xs font-bold text-slate-500 dark:text-slate-400 mb-1.5 block">Assign Classes (Multi-select)</label>
 <div className="flex flex-wrap gap-2 mt-2">
 {classes.map(c => (
 <button
 key={c.id}
 ...
 <div>
 <label className="text-xs font-bold text-slate-500 dark:text-slate-400 mb-1.5 block">Started Date (In Profession)</label>
 ...
 <div>
 <label className="text-xs font-bold text-slate-500 dark:text-slate-400 mb-1.5 block">Joined Date (At School)</label>
 ...
 <div>
 <label className="text-xs font-bold text-slate-500 dark:text-slate-400 mb-1.5 block">Education Level</label>
 ...
 <div>
 <label className="text-xs font-bold text-slate-500 dark:text-slate-400 mb-1.5 block">Last Certificate</label>
 ...
 <div>
 <label className="text-xs font-bold text-slate-500 dark:text-slate-400 mb-1.5 block">Extra Certificates</label>
 ...
 <label className="text-xs font-bold text-slate-500 dark:text-slate-400 mb-1.5 block">Where Trained?</label>
 ...
 <label className="text-xs font-bold text-slate-500 dark:text-slate-400 mb-1.5 block">Other Languages</label>
 ...
 <div>
 <label className="text-xs font-bold text-slate-500 dark:text-slate-400 mb-1.5 block">Relation Type</label>
 ...
 <label className="text-xs font-bold text-slate-500 dark:text-slate-400 mb-1.5 block">Address</label>
 ...
 <div>
 <label className="text-xs font-bold text-slate-500 dark:text-slate-400 mb-1.5 block">Email (Optional)</label>
 ...
 <button type="submit" className="px-8 py-2.5 bg-primary text-white text-sm font-bold rounded-xl shadow-lg shadow-primary/20 hover:bg-blue-700 transition-all transform active:scale-95">Save teacher record</button>
 </div>
 </form>
 </div>
 );
...
const TeacherProfile = ({ teacher, onClose, classes, schoolName }) => {
 ...
 <div className="col-span-full">
 <p className="text-xs font-bold text-slate-400 mb-3">Subjects Taught</p>
 ...
 <span className="material-symbols-outlined text-indigo-600 text-xl">class</span>
 </div>
 <div>
 <p className="text-sm font-bold text-slate-800 dark:text-slate-100">{cls?.name}</p>
 <p className="text-xs text-slate-400 font-bold ">Active Class</p>
 </div>
 </div>
 );
 })}
 ...
 <div className="mt-2">
 <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-semibold ${teacher.status === 'Active' ? 'bg-emerald-100 text-emerald-700' : 'bg-slate-200 text-slate-600'
 }`}>
 Official
 </span>
 </div>
...
const PrintableTeacherProfile = ({ teacher, classes, schoolName }) => {
 ...
 <p className="text-xs font-bold text-slate-500 ">Official Teacher Record</p>
 </div>
 </div>
 ...
 <p className="mt-1 font-mono text-xs text-slate-400 ">Employee ID: TCH-{teacher.id}</p>
 </div>
 </div>
 ...
 <div className="flex flex-wrap gap-2 mt-2">
 {(teacher.assignedClasses || []).map(cid => (
 <span key={cid} className="px-2 py-1 bg-slate-100 rounded text-xs font-bold border border-slate-200 ">
 ...
 <p className="text-xs font-bold text-slate-500">Manager Signature</p>
 </div>
 <div className="text-center w-48">
 <div className="h-16 border-b border-slate-300 mb-2"></div>
 <p className="text-xs font-bold text-slate-500">Teacher Signature</p>
 </div>
 </div>
 </div>
 );
...
const FormSectionHeader = ({ icon, title }) => (
 ...
 <h4 className="font-bold text-slate-800 dark:text-slate-100 text-xs">{title}</h4>
 </div>
);
