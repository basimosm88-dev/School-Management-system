...
const TeachersPage = () => {
  ...
  return (
    <PageLayout role="admin" title="Teachers">
                  ...
                  >
                    <td className="px-6 py-4">
                      <div className="flex flex-col">
                        <span className="font-semibold text-slate-800 dark:text-slate-200">{teacher.name}</span>
                        <span className="text-[11px] text-slate-400 uppercase font-bold tracking-tight">{teacher.specialty}</span>
                      </div>
                    </td>
                    <td className="px-6 py-4">
                      <div className="flex flex-col gap-0.5">
                        <div className="flex items-center gap-1.5 text-slate-600 dark:text-slate-400">
                          ...
                          <span className="text-xs truncate max-w-[150px]">{teacher.email}</span>
                        </div>
                    ...
                    <td className="px-6 py-4">
                      <div className="flex flex-wrap gap-1 max-w-[200px]">
                        {(teacher.assignedClasses || []).map(cid => (
                          <span key={cid} className="px-1.5 py-0.5 bg-blue-50 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400 rounded text-[10px] font-bold uppercase">
                    ...
                    <td className="px-6 py-4">
                      <span className={`px-2 py-1 rounded text-[10px] font-bold uppercase ${teacher.status === 'Active'
    ...
    <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm overflow-y-auto animate-in fade-in duration-300">
      <div className="bg-white dark:bg-slate-900 rounded-2xl w-full max-w-4xl shadow-2xl border border-slate-200 dark:border-slate-700/50 my-auto animate-in zoom-in-95 duration-300">
        ...
        <div className="p-8 max-h-[75vh] overflow-y-auto space-y-12">
          ...
          <section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                <label className="text-[11px] font-bold text-slate-500 dark:text-slate-400 mb-1.5 uppercase tracking-wider block">Marital Status</label>
              ...
              <div className="col-span-full">
                <label className="text-[11px] font-bold text-slate-500 dark:text-slate-400 mb-1.5 uppercase tracking-wider block">Residential Address</label>
          ...
          <section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <label className="text-[11px] font-bold text-slate-500 dark:text-slate-400 mb-1.5 uppercase tracking-wider block">Email Address (Login Username)</label>
          ...
          <section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <label className="text-[11px] font-bold text-slate-500 dark:text-slate-400 mb-1.5 uppercase tracking-wider block">Specialty</label>
              ...
              <div>
                <label className="text-[11px] font-bold text-slate-500 dark:text-slate-400 mb-1.5 uppercase tracking-wider block">Subjects (Multi-select)</label>
                <div className="flex flex-wrap gap-2 mt-2">
                  {subjects.map(s => (
                    <button
                      ...
                      className={`px-3 py-1.5 rounded-lg text-xs font-bold transition-all border ${formData.subjects.includes(s.name)
              ...
              <div className="col-span-full">
                <label className="text-[11px] font-bold text-slate-500 dark:text-slate-400 mb-1.5 uppercase tracking-wider block">Assign Classes (Multi-select)</label>
                <div className="flex flex-wrap gap-2 mt-2">
                  {classes.map(c => (
                    <button
                      key={c.id}
                      ...
                      className={`px-3 py-1.5 rounded-lg text-xs font-bold transition-all border ${formData.assignedClasses.includes(c.id)
                          ? 'bg-primary text-white border-primary shadow-sm shadow-primary/20'
                          : 'bg-white dark:bg-slate-800 text-slate-600 dark:text-slate-400 border-slate-200 dark:border-slate-700 hover:border-primary/50'
                        }`}
                    >
              ...
              <div>
                <label className="text-[11px] font-bold text-slate-500 dark:text-slate-400 mb-1.5 uppercase tracking-wider block">Started Date (In Profession)</label>
              ...
              <div>
                <label className="text-[11px] font-bold text-slate-500 dark:text-slate-400 mb-1.5 uppercase tracking-wider block">Joined Date (At School)</label>
          ...
          <section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div>
                <label className="text-[11px] font-bold text-slate-500 dark:text-slate-400 mb-1.5 uppercase tracking-wider block">Education Level</label>
              ...
              <div>
                <label className="text-[11px] font-bold text-slate-500 dark:text-slate-400 mb-1.5 uppercase tracking-wider block">Last Certificate</label>
              ...
              <div>
                <label className="text-[11px] font-bold text-slate-500 dark:text-slate-400 mb-1.5 uppercase tracking-wider block">Extra Certificates</label>
          ...
          <section>
            ...
            <div className="space-y-4">
              <label className="flex items-center gap-3 cursor-pointer group">
                ...
                />
                <span className="text-sm font-bold text-slate-700 dark:text-slate-200">Trained as Professional Teacher?</span>
              </label>
              {formData.trainedAsTeacher && (
                <div className="animate-in slide-in-from-top-2 duration-300">
                  <label className="text-[11px] font-bold text-slate-500 dark:text-slate-400 mb-1.5 uppercase tracking-wider block">Where Trained?</label>
          ...
          <section>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <div className="col-span-full mt-2">
                <label className="text-[11px] font-bold text-slate-500 dark:text-slate-400 mb-1.5 uppercase tracking-wider block">Other Languages</label>
          ...
          <section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div>
                <label className="text-[11px] font-bold text-slate-500 dark:text-slate-400 mb-1.5 uppercase tracking-wider block">Relation Type</label>
              ...
              <div className="lg:col-span-2">
                <label className="text-[11px] font-bold text-slate-500 dark:text-slate-400 mb-1.5 uppercase tracking-wider block">Address</label>
              ...
              <div>
                <label className="text-[11px] font-bold text-slate-500 dark:text-slate-400 mb-1.5 uppercase tracking-wider block">Email (Optional)</label>
            ...
            <div className="flex gap-8">
              {['Active', 'On Leave', 'Inactive'].map(s => (
                <label key={s} className="flex items-center gap-3 cursor-pointer group">
                  ...
                  <span className="text-sm font-medium text-slate-700 dark:text-slate-300 group-hover:text-primary transition-colors">{s}</span>
                </label>
              ))}
            </div>
          </section>
        ...
        <div className="p-6 border-t border-slate-100 dark:border-slate-800 bg-slate-50 dark:bg-slate-900 flex justify-end gap-3 rounded-b-2xl sticky bottom-0">
          ...
          <button onClick={() => onSave(formData)} className="px-8 py-2.5 bg-primary text-white text-sm font-bold rounded-xl shadow-lg shadow-primary/20 hover:bg-blue-700 transition-all transform active:scale-95">Save Teacher Record</button>
        </div>
      </div>
    </div>
  );
      ...
      <div className="bg-white dark:bg-slate-900 rounded-2xl w-full max-w-5xl shadow-2xl border border-slate-200 dark:border-slate-700/50 my-auto overflow-hidden animate-in zoom-in-95 duration-400">
        <div className="flex justify-between items-center p-8 border-b border-slate-100 dark:border-slate-800 bg-indigo-600 text-white relative">
          <div className="flex items-center gap-6 relative z-10">
            ...
            <div>
              <h3 className="font-bold text-3xl mb-1">{teacher.name}</h3>
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <ProfileSection title="Professional Information" icon="work">
                <div className="grid grid-cols-2 md:grid-cols-3 gap-8">
                  ...
                  <div className="col-span-full">
                    <p className="text-[10px] font-bold text-slate-400 uppercase mb-3">Subjects Taught</p>
                    <div className="flex flex-wrap gap-2">
                      {teacher.subjects?.map(s => (
                        <span key={s} className="px-3 py-1 bg-indigo-50 dark:bg-indigo-900/30 text-indigo-600 dark:text-indigo-400 rounded-full text-xs font-bold border border-indigo-100 dark:border-indigo-800">
                          {s}
                        </span>
                      ))}
                    </div>
                    ...
                    return (
                      <div key={cid} className="flex items-center gap-3 p-3 bg-white dark:bg-slate-800 rounded-xl border border-slate-100 dark:border-slate-700 shadow-sm">
                        <div className="w-8 h-8 rounded-lg bg-indigo-50 dark:bg-indigo-900/30 flex items-center justify-center">
                          <span className="material-symbols-outlined text-indigo-600 text-[18px]">class</span>
                        </div>
                        <div>
                          <p className="text-sm font-bold text-slate-800 dark:text-slate-100">{cls?.name}</p>
                          <p className="text-[10px] text-slate-400 font-bold uppercase">Active Class</p>
                        </div>
                      </div>
                    );
                  })}
              ...
              <ProfileSection title="Employment Status" icon="badge">
                <div className="flex flex-col gap-4">
                  <div className="p-4 rounded-2xl bg-slate-50 dark:bg-slate-800/50 border border-slate-100 dark:border-slate-800">
                    ...
                    <div className="mt-2">
                      <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-[10px] font-black uppercase tracking-widest ${teacher.status === 'Active' ? 'bg-emerald-100 text-emerald-700' : 'bg-slate-200 text-slate-600'
                        }`}>
                        Official
                      </span>
                    </div>
    ...
    <div className="print-only font-sans text-slate-900 bg-white">
      <div className="print-header flex justify-between items-start border-b-2 border-slate-800 pb-6 mb-8">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-[10px] uppercase font-bold text-slate-500 tracking-[0.2em]">Official Teacher Record</p>
          </div>
        </div>
        <div className="text-right text-[11px] leading-relaxed text-slate-600">
          <p className="font-bold text-slate-900">HR Department</p>
          <p>Main Campus, Administrative Block</p>
          <p>Phone: +1 (234) 567-8900</p>
          <p>Email: hr@school.com</p>
          <p className="mt-1 font-mono text-[9px] text-slate-400 uppercase tracking-widest">Employee ID: TCH-{teacher.id}</p>
        </div>
      </div>

      <div className="flex justify-between items-center mb-8">
        <h2 className="text-xl font-bold border-l-4 border-indigo-600 pl-4">TEACHER PERFORMANCE & PROFILE RECORD</h2>
      ...
      <div className="space-y-8">
        ...
        <div className="grid grid-cols-2 gap-8">
          ...
          <div className="print-section">
            ...
            <div className="flex flex-wrap gap-2 mt-2">
              {(teacher.assignedClasses || []).map(cid => (
                <span key={cid} className="px-2 py-1 bg-slate-100 rounded text-[10px] font-bold border border-slate-200 uppercase">
      ...
      <div className="fixed bottom-12 left-12 right-12 flex justify-between pt-8 border-t border-slate-200">
        <div className="text-center w-48">
          ...
          <p className="text-[10px] font-bold uppercase text-slate-500">Manager Signature</p>
        </div>
        <div className="text-center w-48">
          <div className="h-16 border-b border-slate-300 mb-2"></div>
          <p className="text-[10px] font-bold uppercase text-slate-500">Teacher Signature</p>
        </div>
      </div>
    </div>
  );
...
const FormSectionHeader = ({ icon, title }) => (
  <div className="flex items-center gap-3 mb-6 pb-2 border-b border-slate-100 dark:border-slate-800">
    ...
    <h4 className="font-bold text-slate-800 dark:text-slate-100 uppercase tracking-wider text-xs">{title}</h4>
  </div>
);
...
const ProfileSection = ({ title, icon, children }) => (
  <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-100 dark:border-slate-800 shadow-sm overflow-hidden transition-colors">
    <div className="px-6 py-4 border-b border-slate-50 dark:border-slate-800 flex items-center gap-2 bg-slate-50/50 dark:bg-slate-800/30">
      ...
      <h4 className="text-[11px] font-black text-slate-500 dark:text-slate-400 uppercase tracking-widest">{title}</h4>
    </div>
    <div className="p-6">
      {children}
    </div>
...
const PrintItem = ({ label, value }) => (
  <div className="space-y-1">
    ...
    <p className="text-[11px] font-bold text-slate-800">{value || 'N/A'}</p>
  </div>
);
