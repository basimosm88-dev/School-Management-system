...
const ClassesPage = () => {
 ...
 <h2 className="text-heading text-slate-900 dark:text-white">{t('classes')}</h2>
 <p className="text-label text-slate-500/80 mt-1">{t('classesSubtitle')}</p>
 </div>
 ...
 <span className="text-label text-slate-400/80">{cls.academicYear}</span>
 </div>
 </td>
 ...
 <span className="text-label text-slate-700 dark:text-slate-300">
 {classStudentsCount}
 </span>
 </div>
 </td>
 ...
 <td className="px-6 py-4">
 <div className="flex items-center gap-2">
 <div className="w-7 h-7 rounded-lg bg-slate-100 dark:bg-slate-800 flex items-center justify-center text-label text-slate-500/80">
 {supervisor?.name?.[0] || '?'}
 </div>
