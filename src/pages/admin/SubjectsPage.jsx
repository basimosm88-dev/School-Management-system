...
const SubjectsPage = () => {
 ...
 <h2 className="text-headline-sm text-slate-900 dark:text-white">{t('subjects')}</h2>
 <p className="text-body-sm text-slate-500 mt-1">{t('subjectsSubtitle')}</p>
 </div>
 ...
 >
 <span className="material-symbols-outlined text-stat-value">add_circle</span>
 Add Subject
 </button>
 </div>
 ...
 <span className="material-symbols-outlined text-stat-value">auto_stories</span>
 </div>
 ...
 <span className="text-body-sm text-slate-400">p/week</span>
 </div>
 </td>
 <td className="px-6 py-4">
 ...
 <span className="material-symbols-outlined text-display-bold mb-2 opacity-30">menu_book</span>
...
const SubjectForm = ({ subject, onClose, onSave }) => {
 ...
 <div>
 <label className="text-body-sm text-slate-500 mb-1.5 block">Subject Name</label>
 <input 
 type="text" 
 ...
 <div>
 <label className="text-body-sm text-slate-500 mb-3 block">Assigned Levels</label>
 ...
 <div>
 <label className="text-body-sm text-slate-500 mb-1.5 block">Weekly Periods</label>
 <input 
 type="number" 
 min="1"
 className="form-input-custom" 
 ...
 <div>
 <label className="text-body-sm text-slate-500 mb-1.5 block">Description (Optional)</label>
 <textarea 
