...
const StudentDashboard = () => {
 ...
 <h1 className="text-2xl font-semibold mb-1">{t(greetingKey)}, {currentUser.name}!</h1>
 ...
 <p className="text-xs font-bold ">Security Alert: You are using a default password. Please change it in settings.</p>
 </div>
 )}
 </div>
 ...
 <h3 className="text-xs font-bold text-slate-400 mt-6">Upcoming Events</h3>
