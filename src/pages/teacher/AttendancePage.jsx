...
const TeacherAttendancePage = () => {
 ...
 <div>
 <label className="text-xs font-semibold text-slate-400 mb-2 block">Select Session</label>
 <select 
 ...
 className="w-full px-4 py-3.5 bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300 text-xs font-semibold rounded-xl hover:bg-slate-200 dark:hover:bg-slate-700 transition-all disabled:opacity-50"
 >
 Mark All Present
 </button>
 </div>
 ...
 <p className="font-bold text-xs opacity-60">Select class and session to take attendance</p>
 </div>
 ) : (
 ...
 <td className="px-8 py-5">
 <span className="px-3 py-1 bg-slate-100 dark:bg-slate-800 rounded-lg font-mono text-xs font-bold text-slate-500 ">
 {student.id}
 </span>
 </td>
 <td className="px-8 py-5">
 ...
 className={`px-6 py-2 rounded-xl text-xs font-semibold transition-all border ${
 ...
 <button 
 onClick={handleSave}
 className="px-12 py-4 bg-primary text-white text-xs font-semibold rounded-2xl shadow-2xl shadow-primary/30 hover:bg-blue-700 transition-all active:scale-95 flex items-center gap-3"
 >
