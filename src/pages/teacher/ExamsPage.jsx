...
const TeacherExamsPage = () => {
 ...
 <div>
 <label className="text-xs font-semibold text-slate-400 mb-2 block">Exam Type</label>
 <select 
 ...
 <div>
 <label className="text-xs font-semibold text-slate-400 mb-2 block">Select Class</label>
 <select 
 ...
 className="flex-1 px-4 py-3.5 bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300 text-xs font-semibold rounded-xl hover:bg-slate-200 dark:hover:bg-slate-700 transition-all disabled:opacity-30"
 >
 Save Draft
 </button>
 <button 
 ...
 disabled={!selectedSubjectId || isLocked}
 className="flex-1 px-4 py-3.5 bg-primary text-white text-xs font-semibold rounded-xl shadow-lg shadow-primary/20 hover:bg-blue-700 transition-all disabled:opacity-30"
 >
 Submit
 </button>
 ...
 className="flex-1 px-4 py-3.5 bg-emerald-500 text-white text-xs font-semibold rounded-xl shadow-lg shadow-emerald-500/20 hover:bg-emerald-600 transition-all"
 >
 Release Results
 </button>
 )}
 ...
 {isLocked && (
 <p className="text-xs font-bold text-rose-500 tracking-tighter italic">Editing is locked for this exam.</p>
 )}
 </div>
 )}
 
 {successMessage && (
 <div className="mt-4 p-4 bg-emerald-50 dark:bg-emerald-900/20 text-emerald-600 dark:text-emerald-400 text-xs font-semibold rounded-xl border border-emerald-100 dark:border-emerald-800/50 flex items-center gap-3 animate-in fade-in slide-in-from-top-2">
 ...
 <p className="font-bold text-xs opacity-60">Select filters to enter academic results</p>
 </div>
 ) : (
 ...
 <div>
 <span className="font-semibold text-slate-800 dark:text-slate-200 block">{student.name}</span>
 <span className="text-xs text-slate-400 font-bold ">{student.email}</span>
 </div>
 </div>
 </td>
 <td className="px-8 py-5">
 ...
 disabled={isLocked}
 className="w-full px-4 py-2 bg-slate-100 dark:bg-slate-800 border-none rounded-lg font-semibold text-center text-slate-800 dark:text-white focus:ring-2 focus:ring-primary/50 transition-all disabled:opacity-50"
 placeholder="--"
 />
 </td>
 <td className="px-8 py-5">
 ...
 disabled={isLocked}
 className="w-full px-4 py-2 bg-slate-100 dark:bg-slate-800 border-none rounded-lg text-xs font-bold text-slate-600 dark:text-slate-300 focus:ring-2 focus:ring-primary/50 transition-all disabled:opacity-50"
