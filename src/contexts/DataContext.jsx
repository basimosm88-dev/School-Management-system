...
export const DataProvider = ({ children }) => {
  ...
  const value = useMemo(() => ({
    ...
    events, addEvent: addRecord(setEvents), deleteEvent: deleteRecord(setEvents), updateEvent: updateRecord(setEvents),
    announcements, addAnnouncement: addRecord(setAnnouncements), deleteAnnouncement: deleteRecord(setAnnouncements), updateAnnouncement: updateRecord(setAnnouncements),
    messages, addMessage: addRecord(setMessages), deleteMessage: deleteRecord(setMessages), updateMessage: updateRecord(setMessages), sendMessage,
  ...
  }), [students, teachers, classes, subjects, exams, promotionSettings, examReleaseSettings, promotions, grades, attendance, timetables, events, announcements, messages, notifications, systemLogs]);
