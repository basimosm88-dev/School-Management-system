...
const StatCard = ({ title, value, icon, iconColorClass = 'text-primary bg-blue-50', trend, trendUp }) => {
 ...
 {trend && (
 <div className={`flex items-center gap-1 font-bold text-xs px-2.5 py-1 rounded-md shadow-sm ${
 ...
 <div className="mt-2">
 <p className="text-slate-500 dark:text-slate-400 font-semibold text-xs mb-1.5">{title}</p>
