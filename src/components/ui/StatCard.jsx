...
const StatCard = ({ title, value, icon, iconColorClass = 'text-primary bg-blue-50', trend, trendUp }) => {
 ...
 {trend && (
 <div className={`flex items-center gap-1  text-label px-2.5 py-1 rounded-md shadow-sm ${
 ...
 <div className="mt-2">
 <p className="text-slate-500/80 dark:text-slate-400/80 text-label mb-1.5">{title}</p>
 <h3 className="text-display text-slate-900 dark:text-slate-100">{value}</h3>
 </div>
 </div>
 );
};
