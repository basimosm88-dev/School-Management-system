...
const Modal = ({ isOpen, onClose, title, children, onSave, saveText = 'Save Changes' }) => {
 ...
 <button 
 onClick={onSave} 
 className="px-8 py-2.5 text-label text-white bg-primary hover:bg-blue-700 rounded-xl shadow-lg shadow-primary/20 transition-all transform active:scale-95"
 >
 {saveText}
 </button>
 </div>
