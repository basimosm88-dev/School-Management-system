...
const ListModule = ({ role, title, primaryActionText, onPrimaryAction, children }) => {
 ...
 <h2 className="text-lg font-bold text-slate-900 dark:text-slate-100">{title} Directory</h2>
 <div className="flex gap-2">
 <button className="px-4 py-2 border border-slate-200 dark:border-slate-700 text-slate-600 dark:text-slate-400 rounded-lg text-sm font-medium hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors flex items-center gap-2">
